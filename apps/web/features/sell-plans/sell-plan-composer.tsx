            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const defaultSession = market.allowedSessions.includes('regular')
                    ? 'regular'
                    : market.allowedSessions[0];
                  setStages(current => [
                    ...current,
                    {
                      id,
                      allocationBps: 1,
                      minPremiumBps: 0,
                      allowedSessions: defaultSession ? [defaultSession] : [],
                    },
                  ]);
